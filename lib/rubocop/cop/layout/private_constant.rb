  ...
  module Cop
    module Layout
      ...
      class PrivateConstant < Base
        ...
        def on_class(node)
          return unless node.children.last&.begin_type?

          private_constants, private_constant_declarations =
            accumulate_constants(node.children.last.children)

          private_constants.each do |const_node|
            unless private_constant_declarations.include?(const_node.children[1])
        ...
        def accumulate_constants(nodes)
